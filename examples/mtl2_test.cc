...
struct FixedMatrix_
{
  typedef mtl::mat::parameters<mtl::tag::row_major, mtl::index::c_index, mtl::fixed::dimensions<r, c> > param;
...
struct FixedVector_
{
  typedef mtl::vec::parameters<mtl::tag::col_major, mtl::vec::fixed::dimension<d> > param;
